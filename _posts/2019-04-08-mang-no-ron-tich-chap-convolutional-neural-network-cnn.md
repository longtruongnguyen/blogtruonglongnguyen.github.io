...
[Mạng CNN](https://nguyentruonglong.net/mang-no-ron-tich-chap-convolutional-neural-network-cnn.html) được cấu thành bởi một số loại layer sẽ được mô tả chi tiết hơn trong các phần sau bao gồm:
- Convolutional layer
- Pooling layer
