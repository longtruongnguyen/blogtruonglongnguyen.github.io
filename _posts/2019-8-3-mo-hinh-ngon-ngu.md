...
[Mô hình ngôn ngữ](https://nguyentruonglong.net/mo-hinh-ngon-ngu.html) là mô hình mà sẽ tính toán phân phối xác suất của một chuỗi các token trong ngôn ngữ tự nhiên {% raw %}
