...
### Cơ chế giải mã của [mô hình Sequence-to-Sequence](https://nguyentruonglong.net/giai-thich-chi-tiet-ve-mo-hinh-sequence-to-sequence.html) với thuật toán Greedy Search
...
### Cơ chế giải mã của [mô hình Sequence-to-Sequence](https://nguyentruonglong.net/giai-thich-chi-tiet-ve-mo-hinh-sequence-to-sequence.html) với thuật toán Beam Search
