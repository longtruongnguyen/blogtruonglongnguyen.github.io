...
<center>
  ...
  <figcaption>
	  <i>Ảnh minh họa cho quá trình tối ưu hóa hàm mất mát đơn giản {% raw %}$$ \begin{equation} E\left( {{\phi _0},{\phi _1}} \right) \end{equation} $${% endraw %} bằng thuật toán gradient descent. Nguồn: Andrew Ng</i>
  </figcaption>
</center>
</figure>
