...
<center>
  ...
  <figcaption>
	  <i>Ảnh minh họa cho quá trình tối ưu hóa hàm mất mát {% raw %}$$ \begin{equation} E\left( {{\phi _0},{\phi _1}} \right) \end{equation} $${% endraw %} đơn giản bằng thuật toán gradient descent. Nguồn: Andrew Ng</i>
  </figcaption>
</center>
</figure>
